...
RESOURCES += src/qt/zetcoin.qrc src/qt/zetcoin_locale.qrc
TRANSLATIONS += src/qt/locale/zetcoin_bg.ts \
                src/qt/locale/zetcoin_de.ts \
                src/qt/locale/zetcoin_en.ts \
                src/qt/locale/zetcoin_es.ts \
                src/qt/locale/zetcoin_fi.ts \
                src/qt/locale/zetcoin_fr.ts \
                src/qt/locale/zetcoin_it.ts \
                src/qt/locale/zetcoin_ja.ts \
                src/qt/locale/zetcoin_pl.ts \
                src/qt/locale/zetcoin_pt.ts \
                src/qt/locale/zetcoin_ru.ts \
                src/qt/locale/zetcoin_sk.ts \
                src/qt/locale/zetcoin_sv.ts \
                src/qt/locale/zetcoin_vi.ts \
                src/qt/locale/zetcoin_zh_CN.ts \
                src/qt/locale/zetcoin_zh_TW.ts
