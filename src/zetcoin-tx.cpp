...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Zetcoin Core zetcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  zetcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded zetcoin transaction") + "\n" +
              "  zetcoin-tx [options] -create [commands]   " + _("Create hex-encoded zetcoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded zetcoin transaction
