...
/* *** BEGIN DARKSEND MAGIC - ZTC **********
    Copyright (c) 2014-2015, Zetcoin Developers
        eduffield - evan@zetcoinpay.io
        udjinm6   - udjinm6@zetcoinpay.io
*/
    ...
    if(fMasterNode) {
        ...
        BOOST_FOREACH(const CTransaction& txCollateral, vecSessionCollateral) {
            ...
            /*
                ...
                allow endless transaction that would bloat Zetcoin and make it unusable. To
