...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Zetcoin server stopping";
}
...
{ //  category              name                      actor (function)         okSafeMode threadSafe reqWallet
  //  --------------------- ------------------------  -----------------------  ---------- ---------- ---------
    ...
    /* Zetcoin features */
    { "zetcoin",               "masternode",             &masternode,             true,      true,       false },
    { "zetcoin",               "masternodelist",         &masternodelist,         true,      true,       false },
    { "zetcoin",               "mnbudget",               &mnbudget,               true,      true,       false },
    { "zetcoin",               "mnbudgetvoteraw",        &mnbudgetvoteraw,        true,      true,       false },
    { "zetcoin",               "mnfinalbudget",          &mnfinalbudget,          true,      true,       false },
    { "zetcoin",               "mnsync",                 &mnsync,                 true,      true,       false },
    { "zetcoin",               "spork",                  &spork,                  true,      true,       false },
#ifdef ENABLE_WALLET
    { "zetcoin",               "darksend",               &darksend,               false,     false,      true  }, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
         ...
         (mapArgs["-rpcuser"] == mapArgs["-rpcpassword"])) && Params().RequireRPCPassword())
    {
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
            _("To use zetcoind, or the -server option to zetcoin-qt, you must set an rpcpassword in the configuration file:\n"
              "%s\n"
...
std::string HelpExampleCli(string methodname, string args){
    return "> zetcoin-cli " + methodname + " " + args + "\n";
}
