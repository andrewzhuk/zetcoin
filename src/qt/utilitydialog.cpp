    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Zetcoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (about)
    {
        setWindowTitle(tr("About Zetcoin Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  zetcoin-qt [" + tr("command-line options") + "]                     " + "\n";
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Zetcoin Core is shutting down...") + "<br /><br />" +
