    ...
    spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Zetcoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle *networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Zetcoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and zetcoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Zetcoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Zetcoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Zetcoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Zetcoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Zetcoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a zetcoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Zetcoin Core help message to get a list with possible Zetcoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Zetcoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Zetcoin network", "", count));
}
...
{
    QString strTitle = tr("Zetcoin Core"); // default title
