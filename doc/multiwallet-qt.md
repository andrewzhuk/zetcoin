...
Only requiring some minor changes is zetcoin.cpp.
...
Changes to zetcoin.cpp
----------------------
zetcoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
