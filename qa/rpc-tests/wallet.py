...
#   c) node1 mines 101 blocks, so now nodes 0 and 1 have 500 ZTC, node2 has none. 
#   d) node0 sends 21 ZTC to node2, in two transactions (11 ZTC, then 10 ZTC).
...
class WalletTest (BitcoinTestFramework):
    ...
    def run_test (self):
        ...
        # Send 21 ZTC from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 1000 ZTC in block rewards plus fees, but
